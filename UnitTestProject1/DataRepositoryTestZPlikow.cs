...
{
    [TestClass]
    public class DataRepositoryTestZPlikow
    {
        private static IWypelnianieStalymi Wypelniacz = new WypelnianieStalymiZPlikow();
        ...
        {
            IWypelnianieStalymi wypelniacz = new WypelnianieStalymiZPlikow();
